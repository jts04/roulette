...
export const stages: StageDef[] = [
...

    {
        ...
        wheels: [
            // x, y, power, center_x, center_y, size
            // power: 회전 속도
            // center: 회전 중심
            [9.5, 16, 10, 0, 0, 0.25],
            [10.5, 16, -10, 0, 0, 0.25],
        ...
        boxes: [
            ...
            [10.7, 30, rad(45), 0.2, 0.2],
            [12, 30, rad(45), 0.2, 0.2],
            [13.3, 30, rad(45), 0.2, 0.2],
            [14.6, 30, rad(45), 0.2, 0.2],
            [9.4, 32, rad(45), 0.2, 0.2],
            [11, 32, rad(45), 0.2, 0.2],
            [12.6, 32, rad(45), 0.2, 0.2],
            [14.2, 32, rad(45), 0.2, 0.2],
            [15.8, 32, rad(45), 0.2, 0.2],

            [12.7, 40, rad(45), 0.75, 0.75],

            [14, 66.2, rad(45), 0.1, 0.1],
            [13, 66, rad(45), 0.1, 0.1],
            [12, 66.5, rad(45), 0.1, 0.1],
            [11, 67.5, rad(45), 0.1, 0.1],
            [10.5, 68.5, rad(45), 0.1, 0.1],
            [11, 69.5, rad(45), 0.1, 0.1],
            [12, 70.5, rad(45), 0.1, 0.1],
            [13, 71, rad(45), 0.1, 0.1],
            [14, 70.8, rad(45), 0.1, 0.1],
            [15.5, 67.5, rad(45), 0.1, 0.1],
            [15.5, 69.5, rad(45), 0.1, 0.1],
            [15.3, 70.2, rad(45), 0.1, 0.1],

            [11.5, 84, rad(45), 0.5, 0.5],
            [15.5, 84, rad(45), 0.5, 0.5],
        ],
        jumpers: [
            // x, y, size, temporary (1회용)
            [11.5, 8, 0.25, true],
            [12.4, 8, 0.25, true],
            [13.3, 8, 0.25, true],
            [14.2, 8, 0.25, true],
